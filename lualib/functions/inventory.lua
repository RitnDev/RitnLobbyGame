...
local function initInventory()
  ...
  invGlobal[defines.inventory.character_main] = game.create_inventory(ritnmods.tp.defines.value.inventory_size)
  invGlobal[defines.inventory.character_guns] = game.create_inventory(ritnmods.tp.defines.value.inventory_size)
  invGlobal[defines.inventory.character_ammo] = game.create_inventory(ritnmods.tp.defines.value.inventory_size)
  invGlobal[defines.inventory.character_armor] = game.create_inventory(ritnmods.tp.defines.value.inventory_size)
  invGlobal[defines.inventory.character_trash] = game.create_inventory(ritnmods.tp.defines.value.inventory_size)
...
local function clearCursor(LuaPlayer, itemName, origine)
  ...
  if origine then 
    if LuaPlayer.surface.name == global.tp.players[LuaPlayer.name].origine then return end 
  else 
  ...
  if LuaItemStack.name ~= itemName then 
    ...
    LuaPlayer.print(ritnmods.tp.defines.name.caption.msg.cursor)
  end
end
